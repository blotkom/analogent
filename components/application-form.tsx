...
export function ApplicationForm({ position }: ApplicationFormProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (formData.coverLetter) form.append("cover_letter", formData.coverLetter)
    form.append("job_slug", position.id)
      ...
      <Card className="border-border">
        <CardContent className="p-12 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            Thank you for your interest in the {position.title} position. We'll review your application and get back to
  ...
  return (
    <Card className="border-border">
      <CardHeader>
        <CardTitle className="text-2xl text-card-foreground">Application Details</CardTitle>
      </CardHeader>
      <CardContent>
          ...
          <div className="space-y-2">
            ...
            <Select onValueChange={(value) => handleInputChange("visa", value)}>
              ...
              <SelectContent>
                ...
                <SelectItem value="other">Other (please specify in cover letter)</SelectItem>
